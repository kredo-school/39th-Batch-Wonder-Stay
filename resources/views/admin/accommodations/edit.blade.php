...
@section('content')
<h1 style="margin:0 0 16px 0;">Edit accommodation</h1>
...
<select name="hotel_id" style="width:100%; padding:8px; border:1px solid #bbb; border-radius:8px;">
    ...
    <div style="margin-bottom:14px;">
        ...
        <input type="text" name="room_number"
            value="{{ old('room_number', $hotelDetail->room_number) }}"
            placeholder="e.g. 101"
    ...
    <div style="margin-bottom:14px;">
        ...
        <input type="text" name="size_area" inputmode="decimal"
            value="{{ old('size_area', $hotelDetail->size_area) }}"
    ...
    $selectedAmenities = array_filter(array_map(
        'trim',
        explode(',', old('amenities', $hotelDetail->amenities ?? ''))
    ));
@endphp
